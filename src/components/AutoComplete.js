...
export const AutoComplete = Base(($props, $slots) => {
    ...
    const content = View(props, [AutoCompleteInput({value: items, placeholder: placeholder},), $slots])
 ...
 */
export const AutoCompleteInput = Base(($props, $slots) => {
    const {
    ...
    const input = View({tag: 'input', AutoComplete: 'off', placeholder : 'select one', value: "item1,item2,item3"}, )
